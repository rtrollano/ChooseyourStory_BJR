...
INSERT INTO adventures (id_adventure, name) VALUES
(1, 'Expedición al Sector Z-47'),
(2, 'La carta anónima');


INSERT INTO game_states_master (id_state, name, initial_value) VALUES
(1, 'nave', 10),
(2, 'tripulacion', 8),
(3, 'Salud', 5);


INSERT INTO characters (id_character, name) VALUES
(1, 'Capitán: Shelton'),
...
INSERT INTO adventure_states (id_adventure, id_state) VALUES
(1, 1),  -- 'nave'
(1, 2),  -- 'tripulacion'
(2, 3); -- 'salud'


INSERT INTO adventure_context (id_adventure, context_text) VALUES
...
INSERT INTO answers (id_answer, id_adventure, id_step, description, resolution_answer, crew_loss, damage_ship, salud, next_step) VALUES
-- ===== Paso 1 =====
