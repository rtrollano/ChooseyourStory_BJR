...
while flag_main:
    ...
    if opc == 1:
        ...
        if not login:
            ...
            print("Ya has iniciado sesión, {}".format(login))
            ...
            # ======================== 1)Logout ================================
                ...
                while flag_02:
                    ...
                    while juego_on:
                        ...
                        # Ya no necesitas volver a llamar a get_answers_bystep_adventure
                        # answers_dict ya fue creado antes del bucle
                        ...
                        print(getFormatedAnswers(1, answers_dict[idAdventure][(answer_posible[0], current_step)]['Description'], LINE_WIDTH,
                                                 LEFT_MARGIN))
                        print(getFormatedAnswers(2, answers_dict[idAdventure][(answer_posible[1], current_step)]['Description'], LINE_WIDTH,
                                                 LEFT_MARGIN))
