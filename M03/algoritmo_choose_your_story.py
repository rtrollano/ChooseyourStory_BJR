...
# ========================= 2)Play ================================
    while flag_02:
        ...
        while juego_on:
            ...
            LEFT_MARGIN = 10
            LINE_WIDTH = 60
            print(getFormatedAnswers(1, answers_dict[(answer_posible[0], current_step)]['Description'], LINE_WIDTH,
                                     LEFT_MARGIN))
            print(getFormatedAnswers(2, answers_dict[(answer_posible[1], current_step)]['Description'], LINE_WIDTH,
                                     LEFT_MARGIN))
